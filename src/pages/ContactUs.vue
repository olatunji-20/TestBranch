<template>
  <div class="text-center">
    <div class="border-2 border-green-400 p-20 bg-gradient-to-b from-green-200 to-gray-50 ">
        <h2 class="text-h2 text-bold q-pt-md">Contact <span class="text-secondary">Us</span></h2>
