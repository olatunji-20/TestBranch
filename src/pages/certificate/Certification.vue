<template>
    <div class="border-2 border-red-500 h-[900px] p-8 bg-gray-200">
  ...
  const columns = [
    ...
    { name: 'calories', align: 'center', label: 'Name', field: 'calories', sortable: true },
    { name: 'fat', label: 'Group', field: 'fat', sortable: true },
    // { name: 'carbs', label: 'Carbs (g)', field: 'carbs', sortable: true },
    // { name: 'protein', label: 'Protein (g)', field: 'protein', sortable: true },
    { name: 'sodium', label: 'Start date', field: 'sodium', sortable: true },
    { name: 'calcium', label: 'Expiry date (%)', field: 'calcium', sortable: true, sort: (a, b) => parseInt(a, 10) - parseInt(b, 10) },
